...
test "Complex JSON object tokenization" {
    ...
    const expected_tokens = [_]TokenType{ .left_brace, .string, .colon, .string, .comma, .string, .colon, .number, .comma, .string, .colon, .true_literal, .comma, .string, .colon, .null_literal, .right_brace };
...
test "Complex JSON array tokenization" {
    ...
    const expected_tokens = [_]TokenType{ .left_bracket, .number, .comma, .number, .comma, .string, .comma, .true_literal, .comma, .false_literal, .comma, .null_literal, .right_bracket };
...
test "Nested JSON structure tokenization" {
    ...
    const expected_tokens = [_]TokenType{ .left_brace, .string, .colon, .left_brace, .string, .colon, .left_bracket, .number, .comma, .number, .comma, .number, .right_bracket, .right_brace, .right_brace };
